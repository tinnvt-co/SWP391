...
<div class="card p-4">
    ...
    <c:if test="${not empty successMessage}">
        ...
        <c:if test="${not empty resetLink}">
            <div class="alert alert-info py-2" style="word-break:break-all; font-size:.8rem;">
    ...
    <div class="text-center mt-3">
        <a href="${pageContext.request.contextPath}/login" class="text-decoration-none" style="font-size:.85rem;">
